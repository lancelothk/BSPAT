...
import edu.cwru.cbc.BSPAT.commons.ExtensionFilter;
...
//        amplify("/home/kehu/experiments/BSPAT/Amplification/" + celllineName + "_remainPrimer/", "/home/kehu/experiments/BSPAT/Amplification/" + celllineName + "_remainPrimer_10X/", 10);
		for (String cellLineName : cellLineNames) {
			amplify("/home/kehu/experiments/BSPAT/Amplification/" + cellLineName + "_remainPrimer/",
					"/home/kehu/experiments/BSPAT/Amplification/" + cellLineName + "_remainPrimer", 50);
		}
	}
	...
	public static void amplify(String inputPath, String outputPath, int amplifier) throws IOException {
		...
		for (File inputFile : inputFiles) {
			...
			BufferedWriter bufferedWriter = new BufferedWriter(
					new FileWriter(outputPath + "/" + insertBeforeExtensiton(inputFile.getName(), amplifier + "X")));
			String header;
